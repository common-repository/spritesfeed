...
//todo: move persist and api calls to admin functions later?
//require_once SFS_PLUGIN_DIR . '/admin/includes/admin-functions.php';
require_once SFS_PLUGIN_DIR . '/admin/includes/activation-panel.php';
...
//	todo: select methods, works with photosets only, support for galleries, photo feed and more? API seems obsolete though
...
function sfs_admin_insta_options() {
	...
	add_settings_field('sfs-api-client-id', __( 'API Client ID', 'sprites-feed' ),'sfs_render_text_settings_field','sfs-feed-insta-settings', 'sfs-section-api-key', ['option' => 'sfs-insta-credentials', 'label_for' => 'sfs-api-client-id']);
	add_settings_field('sfs-api-client-secret', __( 'API Client Secret', 'sprites-feed' ),'sfs_render_text_settings_field','sfs-feed-insta-settings', 'sfs-section-api-key', ['option' => 'sfs-insta-credentials', 'label_for' => 'sfs-api-client-secret']);
	add_settings_field('sfs-insta-code', __( 'Access Code', 'sprites-feed' ),'sfs_render_text_settings_field','sfs-feed-insta-settings', 'sfs-section-api-key', ['option' => 'sfs-insta-credentials', 'label_for' => 'sfs-insta-code']);
	add_settings_field('sfs-insta-access-key', __( 'Access Token', 'sprites-feed' ),'sfs_render_text_settings_field','sfs-feed-insta-settings', 'sfs-section-api-key', ['option' => 'sfs-insta-credentials', 'label_for' => 'sfs-insta-access-key']);
	add_settings_field('sfs-last-import', __('Last Import', 'sprites-feed'), 'sfs_render_timestamp_settings', 'sfs-feed-insta-settings', 'sfs-section-api-key', ['label_for' => 'sfs-last-import', 'option' => 'sfs-insta-credentials']);
}
...
//todo: keep this one instead of the other _fb_, _yt_ fields. Just add the option into args so we know what's the option group for the field
function sfs_render_text_settings_field($args) {
  $options = get_option($args['option']);
  $value = (isset($options[esc_attr($args['label_for'])])) ? $options[esc_attr($args['label_for'])] : '';
  // output the field
  ?>
