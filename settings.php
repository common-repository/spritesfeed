...
class SFS {
  ...
  public static function load_modules() {
    ...
    self::load_module( 'instagram_access' );
    self::load_module( 'shortcodes' );
  }
...
add_action('wp_enqueue_scripts', 'sfs_enqueue_front_bundles');

function sfs_enqueue_front_bundles($hook) {
  if(!is_admin()):
    wp_enqueue_style('sfs_front_style', plugins_url('./dist/feed.styles.css', __FILE__));
    wp_enqueue_script('sfs_front_scripts', plugins_url( './dist/feed.bundle.js', __FILE__), array(), null, true);
  endif;
}
